...
class JiuJitsu(ArteMarcial):
    def __init__(self):
        ...
        self.golpes = [
            Golpe("Armbar", 22), 
            Golpe("Triangle", 28, vida_enemigo_extra=7), 
            Golpe("Rear choke", 30)
        ]
...
class Judo(ArteMarcial):
    def __init__(self):
        ...
        self.golpes = [
            Golpe("Tai-Otoshi", 8), 
            Golpe("Koshi-guruma", 8, vida_enemigo_extra=5), 
            Golpe("Osoto-gari", 13)
        ]
...
class Karate(ArteMarcial):
    def __init__(self):
        ...
        self.golpes = [
            Golpe("Mae geri", 10), 
            Golpe("Yoko geri", 5, vida_propia=5), 
...
class KungFu(ArteMarcial):
    def __init__(self):
        ...
        self.golpes = [
            Golpe("Ch'ien", 10), 
            Golpe("Kuan tau", 11, vida_propia=10), 
            Golpe("Pei tsu", 22)
        ]
...
class Sumo(ArteMarcial):
    def __init__(self):
        ...
        self.golpes = [
            Golpe("Tsuppari", 18), 
            Golpe("Oshi-dashi", 25, vida_propia=8), 
            Golpe("Yorikiri", 20)
        ]
...
class Taekwondo(ArteMarcial):
    def __init__(self):
        ...
        self.golpes = [
            Golpe("Ap chagi", 15), 
            Golpe("Dollyo chagi", 20, vida_propia=8), 
            Golpe("Naeryo chagi", 18)
        ]
...
class WingChun(ArteMarcial):
    def __init__(self):
        ...
        self.golpes = [
            Golpe("Chain punch", 12), 
            Golpe("Pak sao", 10, vida_propia=7), 
            Golpe("Bong sao", 18)
        ]
